...
export default function MyDocuments({ windowId, focusWindow }: MyDocumentsProps) {
  ...
  const items: FileItem[] = [
    ...
    { name: 'resume.doc', icon: FileIcons.DOCUMENT, type: 'file', size: '24 KB', modified: '3/21/2026' },
    { name: 'notes.txt', icon: FileIcons.DOCUMENT, type: 'file', size: '2 KB', modified: '3/20/2026', onOpen: () => openWindow('notepad', { props: { defaultContent: NOTE_CONTENT } }) },
  ];
