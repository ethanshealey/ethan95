...
interface FreeCellLeaderboardProps {
  windowId: string;
...
export default function FreeCellLeaderboard({ windowId, focusWindow }: FreeCellLeaderboardProps) {
  ...
  const getScores = async () => {
    const res = await fetch('/api/freecell');
